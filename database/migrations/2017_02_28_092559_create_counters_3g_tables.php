	...
	public function up()
	{
		foreach ($this->tables as $table => $options) {
			...
			Schema::create('hua.' . $table, function (Blueprint $table) use($options) {
				...
				$table->$options['type']('c90')->nullable();
				$table->$options['type']('c91')->nullable();
				$table->$options['type']('c92')->nullable();
				$table->$options['type']('c93')->nullable();
				$table->$options['type']('c94')->nullable();
				$table->$options['type']('c95')->nullable();
				$table->$options['type']('c96')->nullable();
				$table->$options['type']('c97')->nullable();
			});
