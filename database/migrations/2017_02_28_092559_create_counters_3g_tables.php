	...
	public function up()
	{
		foreach ($this->tables as $tableName => $options) {
			...
			Schema::create('hua.' . $tableName, function (Blueprint $table) use($fieldType) {
				...
				$table->$fieldType('c90')->nullable();
				$table->$fieldType('c91')->nullable();
				$table->$fieldType('c92')->nullable();
				$table->$fieldType('c93')->nullable();
				$table->$fieldType('c94')->nullable();
				$table->$fieldType('c95')->nullable();
				$table->$fieldType('c96')->nullable();
				$table->$fieldType('c97')->nullable();
			});
