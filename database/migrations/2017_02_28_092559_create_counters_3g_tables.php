...
class CreateCounters3gTables extends Migration
{
    protected $tables = [
        'counters_3g_rop',
        'counters_3g_hour',
        'counters_3g_day',
        'counters_3g_controller_rop',
        'counters_3g_controller_hour',
        'counters_3g_controller_day',
        'counters_3g_province_rop',
        'counters_3g_province_hour',
        'counters_3g_province_day'
    ];
    ...
    public function up()
    {
        foreach ($this->tables as $table) {
            ...
            Schema::create('hua.' . $table, function (Blueprint $table) {
                ...
                $table->smallinteger('c90')->nullable();
                $table->smallinteger('c91')->nullable();
                $table->smallinteger('c92')->nullable();
                $table->smallinteger('c93')->nullable();
                $table->smallinteger('c94')->nullable();
                $table->smallinteger('c95')->nullable();
                $table->smallinteger('c96')->nullable();
                $table->smallinteger('c97')->nullable();
            });
        }
